...
2. Filesystem - Local file operations (scoped to project)
3. Sequential Thinking - Multi-step reasoning
4. GitHub - Repository management
5. Fetch - HTTP requests
6. Time - Date/time operations
7. Serena Claude - Advanced reasoning
8. Python FileOps Enhanced - High-performance file operations
...
2. Check MCP_CONFIG.json exists
3. Verify bun/uv are in PATH
