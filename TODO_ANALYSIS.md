...
2. **Performance TODOs** - Flash attention, SIMD, caching optimizations
3. **Feature Gaps** - XLora support, cross-attention, multi-token handling
...
2. [ ] Replace with graceful errors (`Result<T, Error>`)
3. [ ] Add feature flags where appropriate
4. [ ] Document unsupported features
5. [ ] Add tests to prevent panics
...
4. [ ] Implement mask caching for T5
5. [ ] Add criterion benchmarks for attention
...
3. [ ] Add image/audio serialization support
4. [ ] Complete BnB quantization
5. [ ] Add XLora support for DeepSeek models
...
2. [ ] Update CLIP implementation to match HF
3. [ ] Add missing documentation
4. [ ] Remove obsolete TODOs
5. [ ] Add tests for TODO-marked code paths
...
2. Add tests for the fixed code
3. Update this document
4. Reference the PR in commit message
