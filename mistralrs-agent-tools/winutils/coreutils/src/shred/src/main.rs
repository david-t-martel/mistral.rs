//! Windows-optimized shred utility
//!
//! Securely delete files
//!
//! This is a Windows-optimized version of the shred utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_shred::uumain(processed_args.into_iter().map(OsString::from));
