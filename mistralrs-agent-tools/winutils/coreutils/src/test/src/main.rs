//! Windows-optimized test utility
//!
//! Evaluate conditional expressions
//!
//! This is a Windows-optimized version of the test utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_test::uumain(processed_args.into_iter().map(OsString::from));
