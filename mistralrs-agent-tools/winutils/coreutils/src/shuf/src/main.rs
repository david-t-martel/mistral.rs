//! Windows-optimized shuf utility
//!
//! Shuffle lines
//!
//! This is a Windows-optimized version of the shuf utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_shuf::uumain(processed_args.into_iter().map(OsString::from));
