//! Windows-optimized df utility
//!
//! Display filesystem usage
//!
//! This is a Windows-optimized version of the df utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_df::uumain(processed_args.into_iter().map(OsString::from));
