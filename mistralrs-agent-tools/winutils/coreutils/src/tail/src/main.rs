//! Windows-optimized tail utility
//!
//! Display last lines of files
//!
//! This is a Windows-optimized version of the tail utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_tail::uumain(processed_args.into_iter().map(OsString::from));
