//! Windows-optimized tsort utility
//!
//! Topological sort
//!
//! This is a Windows-optimized version of the tsort utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_tsort::uumain(processed_args.into_iter().map(OsString::from));
