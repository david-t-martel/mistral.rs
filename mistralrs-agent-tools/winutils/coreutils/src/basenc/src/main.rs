//! Windows-optimized basenc utility
//!
//! Multi-base encoding
//!
//! This is a Windows-optimized version of the basenc utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_basenc::uumain(processed_args.into_iter().map(OsString::from));
