//! Windows-optimized printf utility
//!
//! Format and print data
//!
//! This is a Windows-optimized version of the printf utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_printf::uumain(processed_args.into_iter().map(OsString::from));
