//! Windows-optimized truncate utility
//!
//! Truncate files
//!
//! This is a Windows-optimized version of the truncate utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_truncate::uumain(processed_args.into_iter().map(OsString::from));
