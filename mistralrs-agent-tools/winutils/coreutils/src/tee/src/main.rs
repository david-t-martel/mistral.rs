//! Windows-optimized tee utility
//!
//! Copy input to multiple outputs
//!
//! This is a Windows-optimized version of the tee utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_tee::uumain(processed_args.into_iter().map(OsString::from));
