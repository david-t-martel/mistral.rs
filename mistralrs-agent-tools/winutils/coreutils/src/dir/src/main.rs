//! Windows-optimized dir utility
//!
//! List directory contents (Windows style)
//!
//! This is a Windows-optimized version of the dir utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_dir::uumain(processed_args.into_iter().map(OsString::from));
