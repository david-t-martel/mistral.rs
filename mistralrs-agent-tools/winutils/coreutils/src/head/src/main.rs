//! Windows-optimized head utility
//!
//! Display first lines of files
//!
//! This is a Windows-optimized version of the head utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_head::uumain(processed_args.into_iter().map(OsString::from));
