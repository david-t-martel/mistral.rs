//! Windows-optimized mktemp utility
//!
//! Create temporary files
//!
//! This is a Windows-optimized version of the mktemp utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_mktemp::uumain(processed_args.into_iter().map(OsString::from));
