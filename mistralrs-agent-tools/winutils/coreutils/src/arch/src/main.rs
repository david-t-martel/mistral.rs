//! Windows-optimized arch utility
//!
//! Display machine architecture
//!
//! This is a Windows-optimized version of the arch utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_arch::uumain(processed_args.into_iter().map(OsString::from));
