//! Windows-optimized du utility
//!
//! Display directory usage
//!
//! This is a Windows-optimized version of the du utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_du::uumain(processed_args.into_iter().map(OsString::from));
