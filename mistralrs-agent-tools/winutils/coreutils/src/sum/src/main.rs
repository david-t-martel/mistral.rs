//! Windows-optimized sum utility
//!
//! Calculate checksums
//!
//! This is a Windows-optimized version of the sum utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_sum::uumain(processed_args.into_iter().map(OsString::from));
