//! Windows-optimized factor utility
//!
//! Factorize numbers
//!
//! This is a Windows-optimized version of the factor utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_factor::uumain(processed_args.into_iter().map(OsString::from));
