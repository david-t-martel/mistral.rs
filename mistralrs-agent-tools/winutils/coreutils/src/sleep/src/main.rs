//! Windows-optimized sleep utility
//!
//! Delay execution
//!
//! This is a Windows-optimized version of the sleep utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_sleep::uumain(processed_args.into_iter().map(OsString::from));
