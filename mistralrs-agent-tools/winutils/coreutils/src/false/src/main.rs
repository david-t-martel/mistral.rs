//! Windows-optimized false utility
//!
//! Return false exit code
//!
//! This is a Windows-optimized version of the false utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_false::uumain(processed_args.into_iter().map(OsString::from));
