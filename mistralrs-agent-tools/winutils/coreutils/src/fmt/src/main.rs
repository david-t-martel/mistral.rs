//! Windows-optimized fmt utility
//!
//! Format text paragraphs
//!
//! This is a Windows-optimized version of the fmt utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_fmt::uumain(processed_args.into_iter().map(OsString::from));
