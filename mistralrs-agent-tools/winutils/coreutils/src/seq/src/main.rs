//! Windows-optimized seq utility
//!
//! Generate sequence of numbers
//!
//! This is a Windows-optimized version of the seq utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_seq::uumain(processed_args.into_iter().map(OsString::from));
