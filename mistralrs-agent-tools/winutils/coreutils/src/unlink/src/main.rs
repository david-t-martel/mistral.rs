//! Windows-optimized unlink utility
//!
//! Remove single file
//!
//! This is a Windows-optimized version of the unlink utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_unlink::uumain(processed_args.into_iter().map(OsString::from));
