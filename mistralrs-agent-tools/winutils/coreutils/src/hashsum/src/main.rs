//! Windows-optimized hashsum utility
//!
//! Calculate hash sums
//!
//! This is a Windows-optimized version of the hashsum utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_hashsum::uumain(processed_args.into_iter().map(OsString::from));
