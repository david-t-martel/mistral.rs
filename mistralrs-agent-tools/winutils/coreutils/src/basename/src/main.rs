//! Windows-optimized basename utility
//!
//! Extract filename from path
//!
//! This is a Windows-optimized version of the basename utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_basename::uumain(processed_args.into_iter().map(OsString::from));
