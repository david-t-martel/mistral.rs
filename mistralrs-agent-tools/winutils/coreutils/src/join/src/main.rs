//! Windows-optimized join utility
//!
//! Join lines based on common field
//!
//! This is a Windows-optimized version of the join utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_join::uumain(processed_args.into_iter().map(OsString::from));
