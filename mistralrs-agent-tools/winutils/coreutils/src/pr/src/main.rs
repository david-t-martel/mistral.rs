//! Windows-optimized pr utility
//!
//! Format text for printing
//!
//! This is a Windows-optimized version of the pr utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_pr::uumain(processed_args.into_iter().map(OsString::from));
