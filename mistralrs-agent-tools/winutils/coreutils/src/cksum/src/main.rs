//! Windows-optimized cksum utility
//!
//! Calculate checksums
//!
//! This is a Windows-optimized version of the cksum utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_cksum::uumain(processed_args.into_iter().map(OsString::from));
