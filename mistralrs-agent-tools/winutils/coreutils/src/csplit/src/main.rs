//! Windows-optimized csplit utility
//!
//! Split files based on patterns
//!
//! This is a Windows-optimized version of the csplit utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_csplit::uumain(processed_args.into_iter().map(OsString::from));
