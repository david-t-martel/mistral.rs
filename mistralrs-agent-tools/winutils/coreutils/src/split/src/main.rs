//! Windows-optimized split utility
//!
//! Split files
//!
//! This is a Windows-optimized version of the split utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_split::uumain(processed_args.into_iter().map(OsString::from));
