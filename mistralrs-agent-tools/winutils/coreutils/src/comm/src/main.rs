//! Windows-optimized comm utility
//!
//! Compare sorted files line by line
//!
//! This is a Windows-optimized version of the comm utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_comm::uumain(processed_args.into_iter().map(OsString::from));
