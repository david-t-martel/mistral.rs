//! Windows-optimized base64 utility
//!
//! Base64 encode/decode
//!
//! This is a Windows-optimized version of the base64 utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_base64::uumain(processed_args.into_iter().map(OsString::from));
