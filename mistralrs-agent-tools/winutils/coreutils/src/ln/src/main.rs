//! Windows-optimized ln utility
//!
//! Create links
//!
//! This is a Windows-optimized version of the ln utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_ln::uumain(processed_args.into_iter().map(OsString::from));
