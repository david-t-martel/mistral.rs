//! Windows-optimized rmdir utility
//!
//! Remove empty directories
//!
//! This is a Windows-optimized version of the rmdir utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_rmdir::uumain(processed_args.into_iter().map(OsString::from));
