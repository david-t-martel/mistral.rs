//! Windows-optimized dirname utility
//!
//! Extract directory from path
//!
//! This is a Windows-optimized version of the dirname utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_dirname::uumain(processed_args.into_iter().map(OsString::from));
