//! Windows-optimized dircolors utility
//!
//! Setup colors for ls
//!
//! This is a Windows-optimized version of the dircolors utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_dircolors::uumain(processed_args.into_iter().map(OsString::from));
