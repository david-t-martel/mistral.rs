//! Windows-optimized paste utility
//!
//! Merge lines of files
//!
//! This is a Windows-optimized version of the paste utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_paste::uumain(processed_args.into_iter().map(OsString::from));
