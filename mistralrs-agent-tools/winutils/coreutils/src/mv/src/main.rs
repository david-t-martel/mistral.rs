//! Windows-optimized mv utility
//!
//! Move/rename files
//!
//! This is a Windows-optimized version of the mv utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_mv::uumain(processed_args.into_iter().map(OsString::from));
