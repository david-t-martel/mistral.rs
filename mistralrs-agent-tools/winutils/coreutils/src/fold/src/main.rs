//! Windows-optimized fold utility
//!
//! Wrap text lines
//!
//! This is a Windows-optimized version of the fold utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_fold::uumain(processed_args.into_iter().map(OsString::from));
