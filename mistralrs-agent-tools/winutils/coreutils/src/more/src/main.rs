//! Windows-optimized more utility
//!
//! Page through text
//!
//! This is a Windows-optimized version of the more utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_more::uumain(processed_args.into_iter().map(OsString::from));
