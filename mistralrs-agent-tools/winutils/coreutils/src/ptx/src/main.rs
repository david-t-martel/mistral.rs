//! Windows-optimized ptx utility
//!
//! Permuted index
//!
//! This is a Windows-optimized version of the ptx utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_ptx::uumain(processed_args.into_iter().map(OsString::from));
