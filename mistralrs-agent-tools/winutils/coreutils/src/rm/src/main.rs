//! Windows-optimized rm utility
//!
//! Remove files and directories
//!
//! This is a Windows-optimized version of the rm utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_rm::uumain(processed_args.into_iter().map(OsString::from));
