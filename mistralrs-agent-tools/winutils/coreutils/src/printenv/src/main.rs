//! Windows-optimized printenv utility
//!
//! Print environment variables
//!
//! This is a Windows-optimized version of the printenv utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_printenv::uumain(processed_args.into_iter().map(OsString::from));
