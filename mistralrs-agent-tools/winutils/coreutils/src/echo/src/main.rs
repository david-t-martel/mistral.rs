//! Windows-optimized echo utility
//!
//! Display text
//!
//! This is a Windows-optimized version of the echo utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_echo::uumain(processed_args.into_iter().map(OsString::from));
