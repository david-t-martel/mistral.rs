//! Windows-optimized nproc utility
//!
//! Display number of processors
//!
//! This is a Windows-optimized version of the nproc utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_nproc::uumain(processed_args.into_iter().map(OsString::from));
