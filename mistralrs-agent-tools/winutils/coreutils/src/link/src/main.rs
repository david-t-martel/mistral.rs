//! Windows-optimized link utility
//!
//! Create hard links
//!
//! This is a Windows-optimized version of the link utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_link::uumain(processed_args.into_iter().map(OsString::from));
