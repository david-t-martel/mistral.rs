//! Windows-optimized base32 utility
//!
//! Base32 encode/decode
//!
//! This is a Windows-optimized version of the base32 utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_base32::uumain(processed_args.into_iter().map(OsString::from));
