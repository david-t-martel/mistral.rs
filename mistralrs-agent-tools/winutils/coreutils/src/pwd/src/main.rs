//! Windows-optimized pwd utility
//!
//! Print working directory
//!
//! This is a Windows-optimized version of the pwd utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_pwd::uumain(processed_args.into_iter().map(OsString::from));
