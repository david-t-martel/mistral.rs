//! Windows-optimized realpath utility
//!
//! Display absolute path
//!
//! This is a Windows-optimized version of the realpath utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_realpath::uumain(processed_args.into_iter().map(OsString::from));
