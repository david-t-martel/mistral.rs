//! Windows-optimized tr utility
//!
//! Translate characters
//!
//! This is a Windows-optimized version of the tr utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_tr::uumain(processed_args.into_iter().map(OsString::from));
