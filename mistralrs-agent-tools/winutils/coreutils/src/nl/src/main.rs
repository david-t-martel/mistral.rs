//! Windows-optimized nl utility
//!
//! Number lines
//!
//! This is a Windows-optimized version of the nl utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_nl::uumain(processed_args.into_iter().map(OsString::from));
