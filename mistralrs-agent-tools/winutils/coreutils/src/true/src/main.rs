//! Windows-optimized true utility
//!
//! Return true exit code
//!
//! This is a Windows-optimized version of the true utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_true::uumain(processed_args.into_iter().map(OsString::from));
