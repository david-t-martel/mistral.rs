//! Windows-optimized cut utility
//!
//! Extract columns from files
//!
//! This is a Windows-optimized version of the cut utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_cut::uumain(processed_args.into_iter().map(OsString::from));
