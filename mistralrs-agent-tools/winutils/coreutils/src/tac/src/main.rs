//! Windows-optimized tac utility
//!
//! Reverse cat
//!
//! This is a Windows-optimized version of the tac utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_tac::uumain(processed_args.into_iter().map(OsString::from));
