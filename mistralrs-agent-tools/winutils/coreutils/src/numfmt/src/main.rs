//! Windows-optimized numfmt utility
//!
//! Format numbers
//!
//! This is a Windows-optimized version of the numfmt utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_numfmt::uumain(processed_args.into_iter().map(OsString::from));
