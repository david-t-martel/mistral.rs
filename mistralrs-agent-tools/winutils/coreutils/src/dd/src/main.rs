//! Windows-optimized dd utility
//!
//! Convert and copy files
//!
//! This is a Windows-optimized version of the dd utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_dd::uumain(processed_args.into_iter().map(OsString::from));
