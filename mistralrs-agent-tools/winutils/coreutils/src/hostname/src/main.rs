//! Windows-optimized hostname utility
//!
//! Display or set hostname
//!
//! This is a Windows-optimized version of the hostname utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_hostname::uumain(processed_args.into_iter().map(OsString::from));
