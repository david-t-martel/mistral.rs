//! Windows-optimized wc utility
//!
//! Count words, lines, characters
//!
//! This is a Windows-optimized version of the wc utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_wc::uumain(processed_args.into_iter().map(OsString::from));
