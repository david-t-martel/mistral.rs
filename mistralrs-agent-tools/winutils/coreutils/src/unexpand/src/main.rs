//! Windows-optimized unexpand utility
//!
//! Convert spaces to tabs
//!
//! This is a Windows-optimized version of the unexpand utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_unexpand::uumain(processed_args.into_iter().map(OsString::from));
