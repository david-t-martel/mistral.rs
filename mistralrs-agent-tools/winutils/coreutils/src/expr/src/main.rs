//! Windows-optimized expr utility
//!
//! Evaluate expressions
//!
//! This is a Windows-optimized version of the expr utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_expr::uumain(processed_args.into_iter().map(OsString::from));
