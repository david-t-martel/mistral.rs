//! Windows-optimized od utility
//!
//! Octal dump
//!
//! This is a Windows-optimized version of the od utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_od::uumain(processed_args.into_iter().map(OsString::from));
