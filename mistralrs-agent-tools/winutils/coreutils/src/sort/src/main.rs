//! Windows-optimized sort utility
//!
//! Sort lines
//!
//! This is a Windows-optimized version of the sort utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_sort::uumain(processed_args.into_iter().map(OsString::from));
