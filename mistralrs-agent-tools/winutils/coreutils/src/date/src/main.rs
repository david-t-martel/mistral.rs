//! Windows-optimized date utility
//!
//! Display or set system date
//!
//! This is a Windows-optimized version of the date utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_date::uumain(processed_args.into_iter().map(OsString::from));
