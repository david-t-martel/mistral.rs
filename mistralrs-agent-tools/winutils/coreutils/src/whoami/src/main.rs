//! Windows-optimized whoami utility
//!
//! Display current username
//!
//! This is a Windows-optimized version of the whoami utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_whoami::uumain(processed_args.into_iter().map(OsString::from));
