//! Windows-optimized touch utility
//!
//! Update file timestamps
//!
//! This is a Windows-optimized version of the touch utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_touch::uumain(processed_args.into_iter().map(OsString::from));
