//! Windows-optimized uniq utility
//!
//! Remove duplicate lines
//!
//! This is a Windows-optimized version of the uniq utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_uniq::uumain(processed_args.into_iter().map(OsString::from));
