//! Windows-optimized mkdir utility
//!
//! Create directories
//!
//! This is a Windows-optimized version of the mkdir utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_mkdir::uumain(processed_args.into_iter().map(OsString::from));
