//! Windows-optimized sync utility
//!
//! Synchronize filesystems
//!
//! This is a Windows-optimized version of the sync utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_sync::uumain(processed_args.into_iter().map(OsString::from));
