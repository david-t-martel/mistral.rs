//! Windows-optimized expand utility
//!
//! Convert tabs to spaces
//!
//! This is a Windows-optimized version of the expand utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_expand::uumain(processed_args.into_iter().map(OsString::from));
