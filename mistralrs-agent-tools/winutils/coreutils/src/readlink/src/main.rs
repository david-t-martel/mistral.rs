//! Windows-optimized readlink utility
//!
//! Display symlink target
//!
//! This is a Windows-optimized version of the readlink utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_readlink::uumain(processed_args.into_iter().map(OsString::from));
