//! Windows-optimized yes utility
//!
//! Repeatedly output text
//!
//! This is a Windows-optimized version of the yes utility from uutils/coreutils.
...
fn main() {
    ...
    let exit_code = uu_yes::uumain(processed_args.into_iter().map(OsString::from));
